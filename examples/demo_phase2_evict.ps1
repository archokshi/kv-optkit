# ====================================================================
# KV-OptKit Phase 2 Demo: EVICT
# ====================================================================
#
# This script demonstrates the impact of the EVICT action.
...
# --- Step 4: Run Autopilot with EVICT ---
Write-Host "`nStep 4: Requesting an EVICT-only plan..." -ForegroundColor Green
$body = @{
  target_hbm_util = 0.001
  allowed_actions = @("EVICT")
} | ConvertTo-Json
