# ====================================================================
# KV-OptKit Phase 2 Demo: QUANTIZE
# ====================================================================
#
# This script demonstrates the impact of the QUANTIZE action.
...
# --- Step 4: Run Autopilot with QUANTIZE ---
Write-Host "`nStep 4: Requesting a QUANTIZE-only plan..." -ForegroundColor Green
$body = @{
  target_hbm_util = 0.001
  allowed_actions = @("QUANTIZE")
} | ConvertTo-Json
